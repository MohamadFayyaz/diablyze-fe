  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-100">
      ...
      <nav className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-2xl font-bold text-blue-500">Diablyze</span>
          </div>
          <div className="hidden md:flex items-center space-x-8">
            <a href="/#" className="text-gray-600 hover:text-blue-500">Home</a>
            <a href="/#cara-pakai" className="text-gray-600 hover:text-blue-500">Cara Pakai</a>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="p-6 rounded-xl bg-white shadow-lg hover:shadow-xl transition">
              <h3 className="text-xl font-bold mb-4">Deteksi Mudah</h3>
              <p className="text-gray-600">
                Kami mendeteksi diabetes anda berdasarkan Hipertensi, BMI dan lainnya
              </p>
            </div>
            <div className="p-6 rounded-xl bg-white shadow-lg hover:shadow-xl transition">
              <h3 className="text-xl font-bold mb-4">Klasifikasi Resiko</h3>
              <p className="text-gray-600">
                Kami melakukan klasifikasi dari input anda menjadi resiko diabetes
              </p>
            </div>
            <div className="p-6 rounded-xl bg-white shadow-lg hover:shadow-xl transition">
              <h3 className="text-xl font-bold mb-4">Rekomendasi Awal</h3>
              <p className="text-gray-600">
      ...
      <section className="container mx-auto px-6 py-20">
        <h2 className="text-4xl font-bold text-blue-500 mb-8">Tentang Kami</h2>
        <div className="max-w-3xl bg-white p-8 rounded-xl shadow-lg">
          <p className="text-gray-600 mb-6">
            <span className="font-bold">Diablyze</span> adalah platform pintar berbasis teknologi{' '}
            <span className="font-bold">kecerdasan buatan (AI)</span> yang dirancang untuk membantu pengguna mendeteksi risiko diabetes secara cepat dan akurat.
          </p>
          <p className="text-gray-600">
            Kami percaya bahwa <span className="font-bold">deteksi dini adalah kunci</span> dalam mengelola diabetes, dan setiap orang berhak memiliki akses terhadap alat kesehatan yang cerdas, praktis, dan mudah digunakan.
          </p>
        </div>
      </section>
      ...
      <section className="py-20" id="cara-pakai">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-blue-500 mb-12">Cara Pakai</h2>
